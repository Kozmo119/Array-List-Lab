...
//        3. Print true if the list contains a 1 next to a 1 somewhere
        for (int i = 0; i < numbers.size(); i++) {
            if (numbers.get(i) == 1 && numbers.get(i+1) == 1){
                System.out.println("The list contains a 1 next to a 1 somewhere");
                break;
            }   else {
                System.out.println("The list does not contain a 1 next to a 1 somewhere");
                break;
            }
...
//
        System.out.println("The new array list of numbers: " + numbers);
        int sum1 = 0;
        for (int i = 0; i < numbers.size(); i++) {
            if (numbers.get(i) == 13) {
                sum1 += 0;
        ...
        System.out.println("The new sum which does not include 13 and the numbers after: " + sum1);
